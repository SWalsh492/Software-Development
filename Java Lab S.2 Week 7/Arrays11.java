...
public class Arrays11
{
	public static void main(String[] args)
	{
		...
		for(int i = 0; i < names.length; i++)
		{
			...
			{
				System.out.println(input + " is number " + i + " on the girls list");
				appears = true;
			}
			else if(names2[i].equals(input))
			{
				System.out.println(input + " is number " + i + " on the boys list");
				appears = true;
			}
			else
			{
		...
		if(appears == false)
		{
			System.out.println("The name " + input + " is not on the list");
		}
